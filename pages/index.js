          ...
          <WalletModalProvider>
            <MetaplexProvider>
              <div className={styles.App}>
                <div className="md:h-[150px] sm:h-[100px] h-[80px] bg-black/[0.52] flex items-center">
                  <div className="flex justify-between container lg:mx-auto max-w-[940px] relative mx-[20px]">
                    ...
                    <nav className="text-white items-center gap-10 md:flex hidden leading-[1]">
                      <a
                        href="https://magiceden.io/marketplace/777ctzns"
                        target="_blank"
                        rel="noreferrer"
                      >
                        BUY
                      ...
                      <a
                        href="https://solclones-solclones.gitbook.io/flwrs-tokenomics/777ctzns"
                        target="_blank"
                        rel="noreferrer"
                      >
                        WHITEPAPER
                    ...
                    >
                      <a
                        className={`text-white text-[20px] leading-[0] cursor-pointer p-[10px] ${
                          toggleMenu ? 'bg-white/[0.5]' : ''
                        }`}
                      >
                ...
                {toggleMenu && (
                  <div className="text-white items-center bg-black/[0.5] flex flex-col gap-5 leading-[1] md:hidden">
                    <a
                      href="https://magiceden.io/marketplace/777ctzns"
                      target="_blank"
                      rel="noreferrer"
